...
<!-- acordion tpor temario -->
<div class="accordion" id="accordionExample-00114c">
...
palabras separadas y signos de puntuación.</li>              
    ...
    <!-- <div class="card">
        <div class="card-header" id="heading-0014-rv">
            <h2 class="mb-0">
                <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#curso0014-rv" aria-expanded="false" aria-controls="curso0014-rv">
                    RAZONAMIENTO VERBAL
                </button>
            </h2>
        </div>
        <div id="curso0014-rv" class="collapse" aria-labelledby="heading-0014-rv" data-parent="#accordionExample-00114c">
            <div class="card-body">
                <ul>
                    <li><b>1. Sinónimos y antónimos</b></li>
                    <li><b>2. Tildación general</b></li>
                    <li><b>3. Tildación didáctica</b></li>
                    <li><b>4. Lectura (comprensión de texto)</b></li>
                    <li><b>5. Conectores</b></li>
                </ul>
            </div>
        </div>
    </div> -->
...
<!-- acordion tpor temario -->
<div class="accordion" id="accordionExample-00114cg">

    <div class="card">
        <div class="card-header" id="heading-0014-cg">
            <h2 class="mb-0">
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#curso-0014-cg" aria-expanded="true" aria-controls="curso-0014-cg">
                    CULTURA GENERAL
                </button>
            </h2>
        </div>
...
<!-- acordion tpor temario -->
<div class="accordion" id="accordionExample-00114f">

    <div class="card">
        <div class="card-header" id="heading-0014-f">
            <h2 class="mb-0">
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#curso-0014-f" aria-expanded="true" aria-controls="curso-0014-f">
                    FÍSICA
                </button>
            </h2>
        </div>
