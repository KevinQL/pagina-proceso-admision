...
<html lang="en">
    ...
    <body>
        ...
        <div class="container py-4">
            ...
            <h2 class="text-center text-muted py-3 px-4">
                Las inscripciones están limitadas no solo por la fecha sino también por la capacidad de aforo autorizada por la DISA APURIMAC II
            </h2>
